...
export function buildTaxSeasonPrepEmail(input: TaxSeasonPrepInput): EmailMessage {
  ...
  const intro = [
    ...
    ``,
    `DriveWealth issues 1099-DIV and 1099-B forms for ${childFirstName}'s UTMA account each year. You'll find them on the Tax Documents page when they're ready (typically mid-February).`,
    ``,
