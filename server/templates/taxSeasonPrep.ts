...
export function buildTaxSeasonPrepEmail(input: TaxSeasonPrepInput): EmailMessage {
  ...
  const intro = [
    ...
    ``,
    `Once investing is live, our broker-dealer partner will issue 1099-DIV and 1099-B forms for ${childFirstName}'s UTMA account each year, and you'll find them on the Tax Documents page when they're ready (typically mid-February).`,
    ``,
