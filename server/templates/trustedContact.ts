...
export function renderStalledHandoffEmail(
  ...
  const text = [
    ...
    `3. If you don't have current contact information for either of them and don't know what's happened, please reply to this email or write to support@kiddofund.com and let us know. We'll work with you on next steps.`,
    "",
  ...
  const html = [
    ...
    `    <li>If you don't have current contact information for either of them and don't know what's happened, please reply to this email or write to support@kiddofund.com and let us know. We'll work with you on next steps.</li>`,
    `  </ol>`,
