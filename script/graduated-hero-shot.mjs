...
await p.goto(base + `/staging?fund=${THEO}`, { waitUntil: "domcontentloaded" });
...
await p.screenshot({ path: path.join(out, "graduated-full.png"), fullPage: true });
console.log("-> graduated-full.png");
await b.close();
