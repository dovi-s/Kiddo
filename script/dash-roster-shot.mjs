...
// Find and scroll to the "building" roster
const roster = p.getByText(/are building/i).first();
await roster.scrollIntoViewIfNeeded().catch(() => {});
await p.waitForTimeout(1200);
await p.screenshot({ path: out + "/dash-roster.png", fullPage: false });
console.log("done");
await b.close();
