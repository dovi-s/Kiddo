      ...
      {step === "payment" ? (
        <View style={styles.card}>
          ...
          <Text style={styles.legalLine}>
            Gifts are permanent once sent. Once invested, assets are held by DriveWealth, LLC — SIPC-protected up to $500,000 (broker failure, not market loss). Values can go up or down.
          </Text>
