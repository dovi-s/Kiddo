        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              The new federal accounts are a solid retirement head-start. Take the free $1,000. They can only hold index funds, they cap what your family can give, and your kid can't touch the money without a penalty until they're nearly 60. A UTMA does the other job.
            </p>
          </div>
              ...
              {overCap && capDelta > 0 ? (
                <>
                  ...
                  <p className="mt-1.5 text-sm text-muted-foreground">
                    Past the $5,000 cap, only the UTMA keeps growing with your family's gifts. That extra is theirs at 18, in companies they chose.
                  </p>
                </>
              ) : (
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  On paper the federal account may even edge ahead here: it starts with a free $1,000. That money carries an early-withdrawal penalty before 59½ and can only hold index funds. The UTMA's {formatMoney(kiddoAt18)} is <span className="font-semibold text-foreground">liquid at 18</span> and can hold the companies your kid actually loves. They do different jobs.
                </p>
              )}
            </section>
          )}
          ...
          <section className="mx-auto mt-10 max-w-2xl space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
              <span className="font-semibold text-foreground">The federal account is genuinely good</span> for a tax-deferred retirement floor, and the free $1,000 is free money. Take it.
            </p>
            <p>
          ...
          <section className="mx-auto mt-12 max-w-2xl text-center">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Free to start. Anyone in your family can send lasting gifts in a few seconds. No cap, no card required.
            </p>
