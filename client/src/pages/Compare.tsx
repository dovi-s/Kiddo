...
const comparisonPages: Record<string, ComparisonPage> = {
  earlybird: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Kiddo keeps the gifting-link experience, but adds stronger event pages, a richer Memory Book, and a more occasion-first product story.",
      ...
      },
      {
        ...
        body: [
          ...
          "What Kiddo brings back from EarlyBird is the easy multi-contributor giving experience: a shareable gift link, no account needed for the gifter, full Memory Book entries (note, photo, video, voice), event pages with QR codes for parties, and reminder emails that bring family back when birthdays and holidays come around. Recurring contributions in Kiddo are set by the parent on Plus or Family, the same parent-side model Acorns Early uses.",
          "If what you want is a parent savings tool inside the wider Acorns ecosystem, that is a real option. If what you want is the gifting link, event pages, and full-media Memory Book that EarlyBird families loved, Kiddo is the closer fit.",
        ],
      },
    ],
  ...
  stockpile: {
    ...
    comparisonRows: [
      ...
      { label: "Event pages", competitor: "No", kora: "Yes" },
      { label: "Memory Book", competitor: "No", kora: "Yes" },
      { label: "QR code for parties", competitor: "No", kora: "Yes" },
  ...
  "fidelity-utma": {
    ...
    metaDescription:
      "Fidelity is great for holding investments. Kiddo is great for the family gifting ritual a brokerage doesn't give you: shareable links, event pages, a Memory Book, and an at-18 handoff that's actually designed.",
    heroTitle: "Fidelity is a brokerage. Kiddo is a gifting ritual.",
    heroBody: [
      "Fidelity, Schwab, and Vanguard are excellent places to hold investments for a child. They are not designed to make giving feel like an event.",
      "Kiddo is the layer on top of a brokerage account that families actually use: a link grandma can open in 30 seconds, an event page for a baby shower, a Memory Book that compounds alongside the money, and an at-18 transition that's been thought through.",
    ],
    ctaLabel: "Start your child's fund",
    ...
    comparisonRows: [
      ...
      { label: "Event pages for birthdays and milestones", competitor: "None", kora: "Custom event pages with QR codes" },
    ...
    sections: [
      {
        ...
        body: [
          ...
          "What Fidelity does NOT do is the part most families struggle with: the actual ritual of giving. There's no shareable link. There's no event page for the baby shower. There's no clean way for grandma to gift from across the country in under a minute without a paper check. Brokerages were built for self-directed investors, not for the family-and-friends gifting layer that builds a kid's fund over 18 years.",
        ],
      },
      {
...
const fullComparisonRows: FullComparisonRow[] = [
  ...
  {
    feature: "Event pages for occasions",
