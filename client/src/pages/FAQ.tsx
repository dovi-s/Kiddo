...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Kiddo is free to start. Free includes one child fund, a gift link, recurring contributions (single-ticker or default-strategy), text Memory Book entries (gifters can always attach photos, videos, and voice), and Kid View so your child can see what they own. Kiddo+ is $4.99 per month or $39 per year for one child, and adds the parent-operator features: custom fund mix (your own ETF allocation), strategy switching, photo/video/voice authoring in your own Memory Book entries, co-parent access, 3 active occasions, and an annual contribution summary for tax records. Kiddo Family is $7.99 per month or $69 per year for every child fund you manage. Across every plan, Kiddo's annual fee is $1 per $1,000 invested (about $10/year on a $10,000 fund), charged only on invested assets. Cash and pending gifts are not charged. Payment processing on gifts is separate and shown before checkout.",
  },
  {
