      ...
      <main className="px-4 pb-20 pt-24 md:pb-28 md:pt-32">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="mx-auto mt-10 max-w-2xl space-y-4 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              <span className="font-semibold text-foreground">A UTMA is a custodial brokerage account in your kid's name</span>, held by a real broker-dealer partner (Member FINRA/SIPC). At majority age (18 in most states, 21 in CA), the kid gets full ownership.
            </p>
