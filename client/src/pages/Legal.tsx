            ...
            <div className="prose prose-sm max-w-none" data-testid="content-terms">
              ...
              <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
                ...
                <div>
                  ...
                  <p>Kiddo offers three plans: Free, Kiddo+, and Kiddo Family. Kiddo+ costs $4.99 per month or $39 per year and covers one child fund. Kiddo Family costs $7.99 per month or $69 per year and covers unlimited child funds in your household. New accounts receive 14 days of Kiddo+ features at no additional charge. Kiddo does not charge a platform fee on gifts: the gift amount goes to the fund in full. Across all plans, Kiddo charges an annual fee of $1 per $1,000 invested (0.10% annually on invested assets only); cash and pending gifts are not charged. This fee is prorated daily and deducted from invested balance. Payment processing fees on gifts are paid by the gift-giver: card, Apple Pay, and Google Pay are approximately 2.9% + $0.30 per transaction, and bank transfers (ACH) are 0.8%, capped at $5. All fees are disclosed before payment.</p>
                </div>
                <div>
